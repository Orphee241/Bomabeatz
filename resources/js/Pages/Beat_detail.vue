    ...
    <div style="width:" className="container-fluid px-5">
        ...
        <div style class="container section1">
            ...
            <div style="margin-bottom: 14em;" class="row">
                ...
                <div class="col-lg-4">
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum odio excepturi fuga
                        dolorem reprehenderit in totam illum accusamus sed ipsa, aspernatur assumenda nulla?
                        Esse eveniet similique ducimus. Non, quo quae.
                        Esse eveniet similique ducimus. Non, quo quae.
                        Esse eveniet similique ducimus. Non, quo quae.
                        Esse eveniet similique ducimus. Non, quo quae.
                ...
                <div style="width: 50%;" class="row">
                    ...
                    <div v-else class="col-lg-4">
                        <button style="padding: 4px 15px;background-color: rgb(39, 19, 85); color: rgb(255, 255, 255);"
                            class="btn btn-sm ">Télécharger le beat</button>
                    </div>
                </div>
            </div>
